...
module_name = ["antirectifier_gpu", "mnist_acgan_gpu", "variational_autoencoder_deconv_gpu", "variational_autoencoder_gpu",
                "conv_lstm_gpu", "conv_lstm_gpu", "imdb_bidirectional_lstm_gpu", "imdb_cnn_lstm_gpu",
                "imdb_lstm_gpu", "mnist_hierarchical_rnn_gpu", "addition_rnn_gpu", "babi_rnn_gpu"]
result = dict()
