...
module_name = ["antirectifier_gpu", "variational_autoencoder_deconv_gpu", "variational_autoencoder_gpu",
                "conv_lstm_gpu", "imdb_bidirectional_lstm_gpu", "imdb_cnn_lstm_gpu",
